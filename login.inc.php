...
class sqlDAL {
    ...
    private static function eval_mysql_bind($stmt, $formats, $values) {
        ...
        /*private*/ public static function iimysqli_stmt_get_result($stmt) {
        global $global;
    ...
    /*private*/ public static function iimysqli_result_fetch_assoc(&$result) {
        global $global;
        $ret = array();
    ...
    if (empty($mailuid) || empty($password)) {
     ...
     exit(); 
        ...
        exit();
            ...
            if ($row = sqlDAL::iimysqli_result_fetch_assoc($result)/*mysqli_fetch_assoc($result)*/) 
